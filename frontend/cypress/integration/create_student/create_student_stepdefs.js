...
And("Submit form", () => {
    cy.wait(200);
    cy.get(
        "body > div:nth-child(8) > div > div.ant-modal-wrap > div > div.ant-modal-content > div.ant-modal-footer > button.ant-btn.ant-btn-primary"
    ).click();
});
...
Then(`{string} should exist in table`, (student_username) => {
    ...
    ).should("contain", student_username);
});
