...
class LandingPage extends Component {
  ...
  handleSignInModalVisibile = () => this.setState({ signinmodal: !this.state.signinmodal });
        ...
        <Layout style={{ minHeight: '100vh' }}>
          ...
          <Layout className="site-layout">
            <Header className="site-layout-background" style={{ padding: 0 }}>
              <LandingNavBar onClick={this.handleSignup} handleSignin={this.handleSignInModalVisibile} />
            </Header>
